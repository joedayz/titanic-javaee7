...
public class Terminal implements Serializable{
	...
	@NotBlank
	@Column(name="nombre_terminal", nullable=false, length = 50)	
	...
	@NotNull
	@Column(name="direccion_terminal", nullable=false, length = 255)
    ...
    @Column(name="telefonos_terminal", nullable=true, length = 50)
