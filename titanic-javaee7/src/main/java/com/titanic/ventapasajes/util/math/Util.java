package com.titanic.ventapasajes.util.math;
...
public class Util {
	...
	private static final String[] CENTENAS = { "", "ciento ", "doscientos ", "trecientos ", "cuatrocientos ", "quinientos ",
			"seiscientos ", "setecientos ", "ochocientos ", "novecientos " };

	public static String obtenerNombreMes(int intMes) {
		String rpta = "";
		switch (intMes) {
		case 1:
			rpta = "Enero";
